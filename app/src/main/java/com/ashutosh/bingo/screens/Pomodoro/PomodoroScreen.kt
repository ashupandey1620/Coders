...
import com.ashutosh.bingo.Components.SnackbarController
import com.ashutosh.bingo.Components.taskTextStyle
import com.ashutosh.bingo.Components.timerTextStyle
import com.ashutosh.bingo.domain.models.Task
import com.ashutosh.bingo.screens.Pomodoro.Components.CustomCircularProgressBar
import com.ashutosh.bingo.ui.theme.BingoTheme
import com.ashutosh.bingo.util.DummyTasks
import com.ashutosh.bingo.util.vibrateDevice
...
fun PomodoroScreen(
	...
	if (totalTime == 0L) {
		...
		timeLeft = if (task.pomodoroTimer != -1) {
			SnackbarController.showCustomSnackbar("Resuming Previous Session", actionColor = Green)
